...
<script setup>
    ...
    const search = ()=>{
        ...
        if(conditionData.value.commodityStatus===0 || conditionData.value.commodityStatus===1){
            obj.commodity.commodityStatus=conditionData.value.commodityStatus
        }else{
            delete obj.commodity.commodityStatus
        }
